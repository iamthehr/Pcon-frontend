...
const MainNavigation = () => {
  ...
  //   useEffect(() => {
  //     const popListener = browserHistory.listen((location, action) => {
  //       if (drawerOpen && action === "POP") {
  //         closeDrawerHandler();
  ...
  return (
    <>
      ...
      {/* <section className={styles["right-section"]}>
          <NavLink
            exact
            to={navigationRoutes.NOTIFICATIONS}
          ...
          {auth.user && (
            <Link
              ...
              className={styles["action-btn"]}
            >
              <img alt="profile" src={auth.user.photoURL} />
            </Link>
          )}
          {!auth.user && (
            <CustomButton
